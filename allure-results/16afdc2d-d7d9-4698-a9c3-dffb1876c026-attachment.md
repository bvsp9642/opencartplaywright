...
- Name: LoginDataDriven.spec.ts >>  Login test data: inValid Login  @datadriven
- Location: tests\LoginDataDriven.spec.ts:19:9
        ...
        - generic [ref=e87]:
          ...
          - generic [ref=e91]:
            - generic [ref=e92]:
              ...
              - textbox "E-Mail Address" [ref=e94]: bvspdd@bvsp.com
            - generic [ref=e95]:
              - generic [ref=e96]: Password
              - textbox "Password" [ref=e97]: sssdd
...
```ts
  ...
  7  | 
  8  | //load json test data from file logindata json
  9  | 
  ...
  16 | {
  17 |    // test(`Login test with JSON data: ${data.testName}`)
  18 | 
  19 |     test(` Login test data: ${data.testName}  @datadriven`, async({page})=>{
  20 | 
